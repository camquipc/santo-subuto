...
export const FileUpload = () => {
  ...
  const handleUpload = () => {
    if (selectedFile === null) {
      ...
      swal("El telefono es requerido", " ", "warning");
      return;
    } else {
      setProgres(true);
    ...
    <>
      <Card >
        ...
        <Card.Body>
          ...
          <input type="text" className="form-control mb-3" name="apellido" placeholder="Apellido"
            value={apellido}
            onChange={handleChangeApellido}
          />
          <input type="text" className="form-control mb-3" name="direccion" placeholder="Dirección"
            value={direccion}
            onChange={handleChangeDireccion}
          />
          <input type="text" className="form-control mb-3" name="telefono" placeholder="Teléfono"
            value={telefono}
            ...
            <>
              <div className="mb-4 div-btn-ad">
                ...
                <input
                  ...
                  style={{ display: 'none' }}
                />
                <small className="form-text text-muted"> Formatos permitidos: (.doc y .docs) (.pdf) (.mp4)</small>
              </div>
